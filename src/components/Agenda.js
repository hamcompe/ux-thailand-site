...
const speaker = {
  ...
  melissa: {
    ...
    name: 'MELISSA PERRI',
    detail: 'is the CEO of Produx Labs; helping organisations become product-led. Melissa is currently writing a book about her experiences for O’Reilly. Get to know more',
  ...
  liam: {
    ...
    detail: 'is an Experience Design Consultant for ThoughtWorks where he helps organisations think more strategically about design. Get to know more',
